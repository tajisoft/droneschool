...
def generate_laser_scan_data(num_data_points):
    return np.random.uniform(low=1, high=500, size=num_data_points)
...
def main():
    master = mavutil.mavlink_connection('tcp:192.168.2.17:5763', source_system=1, source_component=93)
